['If the rabbit visits the dog then the dog is red.', 'If the dog chases the tiger and the dog is big then the tiger does not see the bear.', 'If the tiger sees the rabbit then the rabbit does not chase the dog.', 'If someone is young then they visit the dog.', 'Red people are young.', 'If someone is rough then they chase the bear.', 'The bear chases the dog.', 'The bear is big.', 'The bear is rough.', 'The bear sees the tiger.', 'The dog chases the bear.', 'The dog chases the rabbit.', 'The dog is big.', 'The dog is blue.', 'The rabbit is red.', 'The tiger chases the dog.']The rabbit does not visit the dog.Sure! Let's break down each contextual statement into CVC5 SMT python formulas using the SMT-LIB syntax. 
