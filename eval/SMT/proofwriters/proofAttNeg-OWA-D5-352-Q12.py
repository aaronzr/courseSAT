['Smart people are furry.', 'Red people are furry.', 'If Erin is young then Erin is big.', 'Big people are nice.', 'All round, furry people are young.', 'All nice people are young.', 'Nice, round people are not red.', 'Bob is big.', 'Bob is red.', 'Bob is smart.', 'Bob is young.', 'Erin is round.', 'Erin is smart.', 'Gary is round.', 'Harry is nice.', 'Harry is red.', 'Harry is not round.', 'Harry is smart.', 'Harry is young.']Erin is red.Sure, let's break down each contextual statement and translate them into CVC5 Python formulas. 
