...
def agent_prompt(name, req, transcript_path, verbal_formulas, result, trace, use_verbal=False, use_both=False):
	with open(transcript_path, 'r') as file:
		transcript = json.load(file)
	
	if use_verbal == True: 
		assert(use_both==False)
		prompt = f"""
		...
		taken_algorithmic_analysis: bool, algorithmic_analysis_course: Enum["CS 161"], algorithmic_analysis_course_units_taken: int, taken_computer_organisation: bool, computer_organisation: Enum["CS 107", "CS 107E"], computer_organisation_course_units_taken: int, taken_principles_of_computer_systems: bool, principles_of_computer_system: Enum["CS110", "CS111"], principles_of_computer_system_course_units_taken: int, confirm_requirements: bool)
		```
		Given requirement: {req}, transcript: {transcript}, smt checking result {result}, and smt core output verbalized in English: {verbal_formulas},  please generate a satisfiability python script and fill in the following 
	...
	if use_both == True: 
		...
		taken_algorithmic_analysis: bool, algorithmic_analysis_course: Enum["CS 161"], algorithmic_analysis_course_units_taken: int, taken_computer_organisation: bool, computer_organisation: Enum["CS 107", "CS 107E"], computer_organisation_course_units_taken: int, taken_principles_of_computer_systems: bool, principles_of_computer_system: Enum["CS110", "CS111"], principles_of_computer_system_course_units_taken: int, confirm_requirements: bool)
		```
		Given requirement: {req}, transcript: {transcript}, smt checking result {result}, smt core: {trace}, and smt core verbalized in English: {verbal_formulas}, please generate a satisfiability python script and fill in the following 
		list similar to the FoundationCoursesTaken(...) format above and output the filled-in list below only:
		```
		{name.lower()}CourseTaken(
		...
		taken_algorithmic_analysis: bool, algorithmic_analysis_course: Enum["CS 161"], algorithmic_analysis_course_units_taken: int, taken_computer_organisation: bool, computer_organisation: Enum["CS 107", "CS 107E"], computer_organisation_course_units_taken: int, taken_principles_of_computer_systems: bool, principles_of_computer_system: Enum["CS110", "CS111"], principles_of_computer_system_course_units_taken: int, confirm_requirements: bool)
		```
		Given requirement: {req}, transcript: {transcript}, smt checking result {result}, and smt core output: {trace},  please generate a satisfiability python script and fill in the following 
		list similar to the FoundationCoursesTaken(...) format above and output the filled-in list below only:
		```
		{name.lower()}CourseTaken(
