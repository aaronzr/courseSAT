['Kind people are not young.', 'If someone is nice then they are smart.', 'Young, kind people are smart.', 'All white, young people are kind.', 'If someone is kind then they are big.', 'If someone is smart then they are furry.', 'If someone is white then they are nice.', 'If Anne is smart then Anne is young.', 'If Charlie is furry then Charlie is kind.', 'Anne is not smart.', 'Charlie is white.', 'Dave is big.', 'Dave is nice.', 'Gary is furry.', 'Gary is kind.', 'Gary is white.']Charlie is young.Sure, I'll start by first parsing and translating each given contextual statement into a CVC5 SMT formula using Python, and then I'll handle the test statement.
