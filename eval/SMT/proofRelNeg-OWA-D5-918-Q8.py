['If something sees the cow then the cow is big.', 'If something likes the cat then it visits the cat.', 'If something is big then it is green.', 'If the squirrel likes the rabbit and the squirrel likes the cow then the squirrel is round.', 'If something is blue and it sees the cow then the cow is kind.', 'If the cat is round and the cat likes the rabbit then the rabbit visits the cat.', 'If something sees the cat then it is big.', 'If something is green then it sees the cow.', 'If the cow does not like the cat and the cat is not blue then the cat is not kind.', 'The cat visits the squirrel.', 'The cow is not kind.', 'The cow is round.', 'The cow does not like the squirrel.', 'The cow sees the rabbit.', 'The cow visits the cat.', 'The rabbit is big.', 'The rabbit likes the squirrel.', 'The rabbit visits the cat.', 'The squirrel is round.', 'The squirrel likes the cow.']The cow is not big.Alright, let's carefully translate each contextual statement and the test statement into cvc5 python formulas.
