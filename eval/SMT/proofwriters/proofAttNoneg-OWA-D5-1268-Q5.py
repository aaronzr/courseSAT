['If something is cold and furry then it is rough.', 'All furry things are young.', 'White, rough things are cold.', 'If something is rough and young then it is white.', 'If something is smart and white then it is quiet.', 'If something is rough and quiet then it is smart.', 'If something is young then it is cold.', 'If Harry is white then Harry is smart.', 'If Harry is young then Harry is rough.', 'Charlie is furry.', 'Charlie is smart.', 'Fiona is rough.', 'Fiona is smart.', 'Gary is smart.', 'Harry is quiet.', 'Harry is smart.']Charlie is cold.Alright, let's translate each contextual statement into a CVC5 Python formula.
