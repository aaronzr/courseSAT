Alright, let's break down the provided contextual statements and the test statement into CVC5 SMT-LIB python formulas. I will use the CVC5 Python API for these transformations.
