...
class Student(ASTNode):
    def __init__(self, name, student_id, coterm):
        super().__init__()
        self.name = name
...
manual_intermediate_representation = {
    "Student": {
        "Name": "Alice Smith",
        "StudentID": "123456",
        "Coterm": False
...
#The json file below is generated by LLM: 
llm_intermediate_representation = {
    "Student": {
        "Name": "Alice Smith",
        "StudentID": "123456",
        "Coterm": False
    ...
    "Requirements": [
        {
            ...
            "SubRequirements": [
                {"Course": "CS103", "Satisfied": True, "WaiverAllowed": False},
                {"Course": "Probability (CS109, Stat116, CME106, MS&E220, or EE178)", "Satisfied": False, "WaiverAllowed": False},
                {"Course": "CS161", "Satisfied": True, "WaiverAllowed": False},
                {"Course": "Computer Organ & Sys (CS107 or 107E)", "Satisfied": False, "WaiverAllowed": False},
                {"Course": "Principles of Computer Systems  (CS110 or CS111)", "Satisfied": False, "WaiverAllowed": False}
            ]
        }
    ],
    "Relations": [
        {"RelationType": "MSCS Degree", "Attributes": {"Completed": 7, "ForMS": True, "Waivers": []}}
    ],
    "Constraints": [
        {"ConstraintType": "Total Units", "Condition": "The total number of units must be greater than or equal to 45."}
    ]
}
# Create a parser instance
parser = Parser(llm_intermediate_representation)
