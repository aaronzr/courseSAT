course_units = Certainly! Based on the provided document, here is the list of course units for the ARTIFICIAL INTELLIGENCE DEPTH REQUIREMENT converted to lowercase and formatted in Python list:
